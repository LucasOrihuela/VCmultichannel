            ...
            <div class="row mx-0 pl-0 pr-0" >
                ...
                <div class="col">
                    <div>
                        ...
                        <br />
                       &nbsp;<asp:DropDownList ID="DropDownList0" AutoPostBack="true" runat="server" DataSourceID="SqlDataSource6" DataTextField="Descripcion" DataValueField="hora" class=" form-control form-rounded" style="margin-left:-18px;margin-top:-40px;background-color:white;  width:180px; font-weight: bold; height: 38px; font-size: 1.1rem; color:#c2081b"> </asp:DropDownList>
    ...
    <div id="divOverlay" runat="server" class="overlay" style="display:none;">
        <div id="divPopUP" class="popup" runat="server" style="display:none;" >
            ...
            <div id="divImagen" style="width: 25em; margin:auto auto auto auto; text-align:center;" runat="server">
                <img id="imgEscritorio" src="./dist/img/escritorios/default.png" class="imgDiv"  style=" width: 500px"  runat="server" alt="Imagen no disponible" />
            </div>
...
<script>
    ...
    function getValue(valor, clase, tipoDesc, estadoDesc, Nombre, Numero, foto) {
        ...
        if (estadoDesc == 'Libre') {
            document.getElementById(prefijo + "lblPregunta").innerHTML = 'Reservar la butaca N° ' + Numero + ' en el horario:' + document.getElementById(prefijo + "DropDownList0").value  + ' ?';
        ...
        document.getElementById(prefijo + "imgEscritorio").src = "./dist/img/escritorio/" + foto + ".png?version=1";
        document.getElementById(prefijo + "imgURL").value = "./dist/img/escritorio/" + foto + ".png?version=1";
